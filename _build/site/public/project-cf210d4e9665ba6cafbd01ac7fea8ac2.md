...
Here, the top prediction is “new”, which fits naturally after the given fragment, showing that AdamW not only lowered the loss but also helped the model generate more coherent and relevant continuations.
