...
With these changes combined, I was able to bring the validation loss down to 1.25. After training, the output distribution for the same input as [](#label_token_frequency_first_run) is displayed below. 
